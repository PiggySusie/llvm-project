...
public:
  ...
  /// Create a push registers instruction (e.g., stp x29, x30, [sp, #-16]! for AArch64)
  /// This is used for function prologue to save frame pointer and link register
  virtual void createPushRegisters(MCInst &Inst, MCPhysReg Reg1, MCPhysReg Reg2) const {
    llvm_unreachable("not implemented");
  }

  /// Create a pop registers instruction (e.g., ldp x29, x30, [sp], #16 for AArch64)
  /// This is used for function epilogue to restore frame pointer and link register
  virtual void createPopRegisters(MCInst &Inst, MCPhysReg Reg1, MCPhysReg Reg2) const {
    llvm_unreachable("not implemented");
  }
