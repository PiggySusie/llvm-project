...
extern cl::opt<bolt::IdenticalCodeFolding::ICFLevel, false,
    ...
    ICF;
extern cl::opt<bool> EnablePostLinkOutlining;
extern cl::opt<int> PostLinkOutliningLength;
extern cl::opt<bool> PostLinkOutliningPGO;
extern cl::opt<bool> PostLinkOutliningDebug;
...
static cl::opt<bool>
    PrintPostLinkOutlining("print-post-link-outlining",
                           cl::desc("print functions after post-link outlining pass"),
                           cl::Hidden,
                 cl::cat(BoltOptCategory));
...
Error BinaryFunctionPassManager::runAllPasses(BinaryContext &BC) {
  ...
  // Post-Link Outlining Pass: Outline common instruction sequences
  Manager.registerPass(
      std::make_unique<PostLinkOutlining>(
          PrintPostLinkOutlining,
          opts::PostLinkOutliningLength,
          opts::PostLinkOutliningPGO),
      opts::EnablePostLinkOutlining);
